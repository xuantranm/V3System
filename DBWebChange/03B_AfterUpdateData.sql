...
GO
UPDATE WAMS_STOCK_MANAGEMENT_QUANTITY SET vPOID= NULL, vStatus = 'NOV/14/6493' WHERE vPOID='NOV/14/6493'
UPDATE WAMS_STOCK_MANAGEMENT_QUANTITY SET vPOID= NULL, vStatus = 'DEC/14/7442' WHERE vPOID='DEC/14/7442'
UPDATE WAMS_STOCK_MANAGEMENT_QUANTITY SET vPOID= NULL, vStatus = 'MAY/15/2845' WHERE vPOID='MAY/15/2845'
UPDATE WAMS_STOCK_MANAGEMENT_QUANTITY SET vPOID= NULL, vStatus = 'MAY/15/2845' WHERE vPOID='JUL/15/3792'
UPDATE WAMS_STOCK_MANAGEMENT_QUANTITY SET vPOID= NULL, vStatus = 'MAY/15/2845' WHERE vPOID='SEP/15/5209'
UPDATE WAMS_STOCK_MANAGEMENT_QUANTITY SET vPOID= NULL, vStatus = 'NOV/14/6868' WHERE vPOID='NOV/14/6868'
UPDATE WAMS_STOCK_MANAGEMENT_QUANTITY SET vPOID= NULL, vStatus = 'MAR/15/1404' WHERE vPOID='MAR/15/1404'
UPDATE WAMS_STOCK_MANAGEMENT_QUANTITY SET vPOID= NULL, vStatus = 'NOV/15/6672' WHERE vPOID='NOV/15/6672'
UPDATE WAMS_STOCK_MANAGEMENT_QUANTITY SET vPOID= NULL, vStatus = 'AUG/13/3393' WHERE vPOID='AUG/13/3393'
UPDATE WAMS_STOCK_MANAGEMENT_QUANTITY SET vPOID= NULL, vStatus = 'AUG/13/3590' WHERE vPOID='AUG/13/3590'
UPDATE WAMS_STOCK_MANAGEMENT_QUANTITY SET vPOID= NULL, vStatus = 'DEC/13/5735' WHERE vPOID='DEC/13/5735'
UPDATE WAMS_STOCK_MANAGEMENT_QUANTITY SET vPOID= NULL, vStatus = 'JUL/14/3781' WHERE vPOID='JUL/14/3781'
GO
ALTER TABLE dbo.WAMS_STOCK_MANAGEMENT_QUANTITY ALTER COLUMN vPOID int
GO
UPDATE WAMS_FULFILLMENT_DETAIL SET vPOID= NULL, tDescription = 'NOV/14/6493' WHERE vPOID='NOV/14/6493'
UPDATE WAMS_FULFILLMENT_DETAIL SET vPOID= NULL, tDescription = 'DEC/14/7442' WHERE vPOID='DEC/14/7442'
UPDATE WAMS_FULFILLMENT_DETAIL SET vPOID= NULL, tDescription = 'MAY/15/2845' WHERE vPOID='MAY/15/2845'
UPDATE WAMS_FULFILLMENT_DETAIL SET vPOID= NULL, tDescription = 'MAY/15/2845' WHERE vPOID='JUL/15/3792'
UPDATE WAMS_FULFILLMENT_DETAIL SET vPOID= NULL, tDescription = 'MAY/15/2845' WHERE vPOID='SEP/15/5209'
UPDATE WAMS_FULFILLMENT_DETAIL SET vPOID= NULL, tDescription = 'NOV/14/6868' WHERE vPOID='NOV/14/6868'
UPDATE WAMS_FULFILLMENT_DETAIL SET vPOID= NULL, tDescription = 'MAR/15/1404' WHERE vPOID='MAR/15/1404'
UPDATE WAMS_FULFILLMENT_DETAIL SET vPOID= NULL, tDescription = 'NOV/15/6672' WHERE vPOID='NOV/15/6672'
UPDATE WAMS_FULFILLMENT_DETAIL SET vPOID= NULL, tDescription = 'AUG/13/3393' WHERE vPOID='AUG/13/3393'
UPDATE WAMS_FULFILLMENT_DETAIL SET vPOID= NULL, tDescription = 'AUG/13/3590' WHERE vPOID='AUG/13/3590'
UPDATE WAMS_FULFILLMENT_DETAIL SET vPOID= NULL, tDescription = 'DEC/13/5735' WHERE vPOID='DEC/13/5735'
UPDATE WAMS_FULFILLMENT_DETAIL SET vPOID= NULL, tDescription = 'JUL/14/3781' WHERE vPOID='JUL/14/3781'
GO
...
GO
ALTER TABLE dbo.WAMS_SUPPLIER ALTER COLUMN vTermOfPayment NVARCHAR(MAX)
--GO
...
GO
ALTER TABLE dbo.WAMS_RETURN_LIST ALTER COLUMN ServiceFlag INT NULL
GO
...
GO
ALTER TABLE dbo.WAMS_ITEMS_SERVICE ALTER COLUMN vDescription nvarchar(MAX) null
GO