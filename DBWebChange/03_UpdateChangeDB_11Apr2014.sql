...
INNER JOIN dbo.WAMS_REQUISITION_MASTER AS S
       ON WAS.vMRF = S.vMRF
GO
UPDATE WAMS_STOCK_MANAGEMENT_QUANTITY SET vMRF = MRFCode
GO
UPDATE WAS 
SET WAS.vMRF = S.Id
FROM dbo.WAMS_STOCK_MANAGEMENT_QUANTITY AS WAS
...
UPDATE WAS 
SET WAS.ProjectCode = P.vProjectID,
WAS.ProjectName = P.vProjectName
FROM dbo.WAMS_STOCK_MANAGEMENT_QUANTITY AS WAS
INNER JOIN dbo.WAMS_PROJECT AS P
       ON WAS.vProjectID = P.Id
GO 

UPDATE WAS 
SET WAS.StockCode = P.vStockID,
WAS.StockName = P.vStockName,
WAS.StockTypeId = P.iType,
WAS.StockType = P.[Type],
WAS.CategoryId = P.bCategoryID,
WAS.Category = P.Category,
WAS.UnitId = P.bUnitID,
WAS.Unit = P.Unit,
WAS.[Weight] = P.bWeight
FROM dbo.WAMS_STOCK_MANAGEMENT_QUANTITY AS WAS
...
UPDATE WAS 
SET WAS.Note = P.tDescription
FROM dbo.WAMS_STOCK_MANAGEMENT_QUANTITY AS WAS
INNER JOIN dbo.WAMS_FULFILLMENT_DETAIL AS P
       ON WAS.vStatusID = P.SRV
GO 
UPDATE WAS 
SET WAS.Note = P.[Description]
FROM dbo.WAMS_STOCK_MANAGEMENT_QUANTITY AS WAS
INNER JOIN dbo.WAMS_ASSIGNNING_STOCKS AS P
       ON WAS.vStatusID = P.SIV
GO 
UPDATE WAS 
SET WAS.Note = P.vCondition
FROM dbo.WAMS_STOCK_MANAGEMENT_QUANTITY AS WAS
INNER JOIN dbo.WAMS_RETURN_LIST AS P
       ON WAS.vStatusID = P.SRV
GO 

UPDATE WAMS_STOCK SET vPhotoPath = vPhotoPath + '.jpg'
GO
UPDATE WAMS_STOCK SET vPhotoPath = NULL WHERE vPhotoPath = '.jpg'